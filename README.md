...
* tdTomato.fa: Fasta file that contains the tdTomato sequence that was inserted into the mm39 genome for scRNAseq analysis of lineage traced mice.
* EYFP.fa: Fasta file that contains the EYFP sequence that was inserted into the mm39 genome for scRNAseq analysis of lineage traced mice.
